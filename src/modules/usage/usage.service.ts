...
export class UsageService {
   ...
   *
   * Increases the number of order created during the current billing period
   ...
   * order are created simultaneously for the same company.
   *
   ...
   *
   * Reduces the number of order counted within the current billing period.

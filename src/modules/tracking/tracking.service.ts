...
import { InjectRepository, QueryFailedError } from "@nestjs/typeorm";
...
export class TrackingService {
    ...
    async updateDriverLocation(
        ...
        try {
            ...
            await this.enqueueTriBroadcast(tripId);
    ...
    async broadcastTripUpdate(tripId: string): Promise<void> {
        try {
            ...
            const driver = (
                await this.dispatchService.getDriversForTrips(trip.companyId, [
                    trip
                ])

...
import { ForbiddenAppException, InternalErrorException, ResourceNotFoundException, } from '#/common/exceptions';
import { deriveTripStatus, getCurrentStop, getTripProgress, } from '#/common/utils/trip-status.util';
import { calculateHeading, type GeoPoint, haversineDistanceMeters, } from '#/common/utils/geo-distance.util';
...
import { DispatchService, TripDriver, } from '#/modules/dispatch/dispatch.service';
...
export class TrackingService {
  ...
  async updateDriverLocation(
    ...
    try {
      ...
      this.errorHandler.handle(err, 'TrackingService.updateDriverLocation');
    }
  }
  ...
  toInternalPayload(trip: Trip, driver: TripDriver | null, isOnline: boolean) {
    ...
    return {
      ...
      driverLocation: trip.driverLocationLat
        ? {
            ...
            gpsQuality: this.getGpsQuality(trip.driverLocationAccuracy),

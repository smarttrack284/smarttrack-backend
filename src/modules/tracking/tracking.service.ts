...
export class TrackingService {
        ...
        rule(
          ...
          () =>
            new InternalErrorException(
              'Unable to update driver location at this time. Please try again.',
            ),
        ),
        rule(
          Error,
  ...
  async broadcastTripUpdate(tripId: string): Promise<void> {
    try {
      ...
      throw new InternalErrorException(
        'Unable to broadcast trip update. The job will be retried.',
      );
    }
  }
  ...
  async getPublicSnapshotByTrackingNumber(trackingNumber: string) {
    try {
      ...
      this.errorHandler.handle(
        err,
        'TrackingService.getPublicSnapshotByTrackingNumber',
        [
          rule(
            QueryFailedError,
            () =>
              new InternalErrorException(
                'Unable to retrieve tracking information at this time. Please try again.',
              ),
          ),
          rule(
            Error,

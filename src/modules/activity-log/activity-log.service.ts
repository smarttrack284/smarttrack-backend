...
export class ActivityLogService {
  ...
  async record(input: {
    ...
    try {
      ...
      this.logger.error({
        ...
        err: err instanceof Error ? err.message : new Error(String(err)),
  ...
  handleOrdersBulkImported(event: OrdersBulkImportedEvent) {
    ...
    void this.record({
      ...
      severity: hasFailures ? ActivitySeverity.WARNING : ActivitySeverity.INFO,
      message: hasFailures
